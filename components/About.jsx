...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Shad Ahmor, a passionate web developer and problem
          solver. Currently, I&apos;m the Project manager at Jio Platform Limited in Infosec department, 
          and I&apos;ve completed B.Tech (2025). degree in Information Technology at
          Institute Of Engineering And Technology in Ayodhya, India, . I&apos;m a software developer with experience
          in JavaScript, MaterialUI/Bootstrap CSS,Java and Python. I specialize in frameworks
          such as React, Node.js, Express.js, Springboot/SpringMVC,Django and Three.js.I specialize in database like Oracle, PhpMySQL,MSSQL,PostgreSQL,MongoDB,Firebase. My
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:shadahmor007@gmail.com"
            target="_blank"
            rel="noreferrer"
